...
import { grammarPoints, grammarMistakes, articles, userReadingProgress, words, userWordProgress, wordTransformations, transformationMistakes, grammarExercises, grammarPracticeRecords, grammarWeakPoints } from "./schema";
